...
// ------------------------------------------------------------
// URL classification. The domain -> platform key table is shared with
// the web forms and every other harvester (see
// src/lib/classify-platform-url.ts); CLASSIFY_CONFIGS.discogs carries
// this script's deviations — discogs.com self-links and wikidata.org
// are skipped, on top of the central Twitter/X policy skip.
// ------------------------------------------------------------
...
function classifyUrl(rawUrl) {
  ...
  const platform = classifyPlatformUrl(rawUrl, CLASSIFY_CONFIGS.discogs);
